...
import { ListadoHeader } from "@/components/catalogo/listado-header";
import { VistaProductos } from "@/components/catalogo/vista-productos";
...
export async function ListadoProductos({
  ...
  return (
    <div>
      <ListadoHeader
        titulo={subfamiliaInfo?.nombre ?? familiaInfo.nombre}
        descripcion={subfamiliaInfo?.introCorta || familiaInfo.introCorta}
        familiaSlug={familiaSlug}
      />
